function c({ livewireId: s }) {
    return {
        areAllCheckboxesChecked: !1,
        checkboxListOptions: [],
        search: "",
        ...
        checkIfAllCheckboxesAreChecked() {
            this.areAllCheckboxesChecked =
                ...
                this.visibleCheckboxListOptions.filter((e) =>
                    e.querySelector(
        ...
        toggleAllCheckboxes() {
            this.checkIfAllCheckboxesAreChecked();
            let e = !this.areAllCheckboxesChecked;
            this.visibleCheckboxListOptions.forEach((t) => {
                let i = t.querySelector("input[type=checkbox]");
                i.disabled ||
                    (i.checked !== e &&
                        ((i.checked = e),
                        i.dispatchEvent(new Event("change"))));
            }),
                (this.areAllCheckboxesChecked = e);
        },
        updateVisibleCheckboxListOptions() {
            this.visibleCheckboxListOptions = this.checkboxListOptions.filter(
                (e) =>
                    ["", null, void 0].includes(this.search) ||
                    e
